...
/**
 * {@link ImportBeanDefinitionRegistrar} implementation to activate hypermedia
 * support based on the configured hypermedia type. Activates
 * {@link EntityLinks} support as well (essentially as if
 * {@link EnableEntityLinks} was activated as well).
 * 
...
class HypermediaSupportBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    /**
     * Returns a {@link LinkDiscoverer} {@link BeanDefinition} suitable for the
     * given {@link HypermediaType}.
     * 
     * @param type
     * @return
     */
    ...
    /**
     * {@link BeanPostProcessor} to register {@link Jackson2HalModule} with
     * {@link ObjectMapper} instances registered in the
    ...
    static class Jackson2ModuleRegisteringBeanPostProcessor implements BeanPostProcessor, BeanFactoryAware {
        ...
        public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
            ...
            if (bean instanceof AnnotationMethodHandlerAdapter) {
                ...
                adapter.setMessageConverters(augmentedConverters.toArray(new HttpMessageConverter<?>[augmentedConverters.size()]));
            }
